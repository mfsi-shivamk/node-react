...
query EyeTestFetch($filter: String, $limit: Int, $page: Int) {
  eyeTest(filter: $filter, limit: $limit, page: $page) {
      totalPages
      page
      eyeTest{
      id
    ...
    <main style={{ backgroundColor: "white", height: "100%" }} className={classes.content}>
      ...
      <Container className={classes.cardGrid} maxWidth="md">
        ...
        <Grid container spacing={4}>
          {data && (data.eyeTest.eyeTest.map(({ id, name, score1, score2, score3 }) => (
            <Grid item key={id} xs={12} sm={6} md={4}>
              <Card className={classes.card}>
                ...
                <CardContent className={classes.cardContent}>
                  ...
                  <Typography>
                  Colour Vision Check : {score1}
                    
                  </Typography>
                  <Typography>
                  Contrast Check : {score2}
                  </Typography>
                  <Typography>
                  Visual acuity test : {score3}
                  </Typography>
                </CardContent>
              </Card>
            </Grid>
      ...
      {loading ? (
        ...
        <Grid container justify="center">
          <Pagination page={(data && data.eyeTest )? data.eyeTest.page : 1} count={(data && data.eyeTest )? data.eyeTest.totalPages : 0} onChange={(e, p) => { setLoadState({ ...formState, page: p })}}/>
        </Grid>}
    </main>
  );
}
